...
_ASSETUPDATEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="asset",
            full_name="ProtobufMarkets.AssetUpdateMessage.asset",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="ProtobufMarkets.AssetUpdateMessage.usdVolumeUpdate",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="Update",
            full_name="ProtobufMarkets.AssetUpdateMessage.Update",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_ASSETUSDVOLUMEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="volume",
            full_name="ProtobufMarkets.AssetUSDVolumeUpdate.volume",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_ASSETUPDATEMESSAGE.fields_by_name[
    "usdVolumeUpdate"
].message_type = _ASSETUSDVOLUMEUPDATE
_ASSETUPDATEMESSAGE.oneofs_by_name["Update"].fields.append(
    _ASSETUPDATEMESSAGE.fields_by_name["usdVolumeUpdate"]
)
_ASSETUPDATEMESSAGE.fields_by_name[
    "usdVolumeUpdate"
].containing_oneof = _ASSETUPDATEMESSAGE.oneofs_by_name["Update"]
...
AssetUpdateMessage = _reflection.GeneratedProtocolMessageType(
    "AssetUpdateMessage",
    (_message.Message,),
    {
...
AssetUSDVolumeUpdate = _reflection.GeneratedProtocolMessageType(
    "AssetUSDVolumeUpdate",
    (_message.Message,),
    {
