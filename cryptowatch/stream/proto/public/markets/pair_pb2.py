...
# source: public/markets/pair.proto
...
_PAIRUPDATEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="pair",
            full_name="ProtobufMarkets.PairUpdateMessage.pair",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="vwapUpdate",
            full_name="ProtobufMarkets.PairUpdateMessage.vwapUpdate",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="ProtobufMarkets.PairUpdateMessage.performanceUpdate",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="ProtobufMarkets.PairUpdateMessage.trendlineUpdate",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="Update",
            full_name="ProtobufMarkets.PairUpdateMessage.Update",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_PAIRVWAPUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="vwap",
            full_name="ProtobufMarkets.PairVwapUpdate.vwap",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="ProtobufMarkets.PairVwapUpdate.timestamp",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="timestampNano",
            full_name="ProtobufMarkets.PairVwapUpdate.timestampNano",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
_PAIRPERFORMANCEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="window",
            full_name="ProtobufMarkets.PairPerformanceUpdate.window",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="performance",
            full_name="ProtobufMarkets.PairPerformanceUpdate.performance",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
...
_PAIRTRENDLINEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="window",
            full_name="ProtobufMarkets.PairTrendlineUpdate.window",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="time",
            full_name="ProtobufMarkets.PairTrendlineUpdate.time",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="price",
            full_name="ProtobufMarkets.PairTrendlineUpdate.price",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="volume",
            full_name="ProtobufMarkets.PairTrendlineUpdate.volume",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_PAIRUPDATEMESSAGE.fields_by_name[
    "performanceUpdate"
].message_type = _PAIRPERFORMANCEUPDATE
...
_PAIRUPDATEMESSAGE.fields_by_name[
    "vwapUpdate"
].containing_oneof = _PAIRUPDATEMESSAGE.oneofs_by_name["Update"]
_PAIRUPDATEMESSAGE.oneofs_by_name["Update"].fields.append(
...
PairUpdateMessage = _reflection.GeneratedProtocolMessageType(
    "PairUpdateMessage",
    (_message.Message,),
    {
        "DESCRIPTOR": _PAIRUPDATEMESSAGE,
        "__module__": "public.markets.pair_pb2"
        # @@protoc_insertion_point(class_scope:ProtobufMarkets.PairUpdateMessage)
    },
)
_sym_db.RegisterMessage(PairUpdateMessage)

PairVwapUpdate = _reflection.GeneratedProtocolMessageType(
    "PairVwapUpdate",
    (_message.Message,),
    {
...
PairPerformanceUpdate = _reflection.GeneratedProtocolMessageType(
...
PairTrendlineUpdate = _reflection.GeneratedProtocolMessageType(
    "PairTrendlineUpdate",
    (_message.Message,),
    {
